...
def test_character_creation():
    character = Character(id=1, name="Hero", level=1, max_hp=100, current_hp=100, attack=10, defense=5)
...
def test_monster_creation():
    monster = Monster(id=1, name="Goblin", hp=50, current_hp=50, attack=5, defense=2, xp_reward=10, gold_reward=5)
    assert monster.id == 1
