...
def test_create_character(character_service):
    character = Character(id=0, name="Test Character", level=1, hp=100, max_hp=100, attack=10, defense=5)
...
def test_update_character(character_service):
    character = Character(id=0, name="Test Character", level=1, hp=100, max_hp=100, attack=10, defense=5)
    created_character = character_service.create_character(character)
    updated_character = Character(id=created_character.id, name="Updated Character", level=2, hp=120, max_hp=120, attack=12, defense=6)
