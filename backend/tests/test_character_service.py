...
def test_create_character(character_service):
    character = Character(id=0, name="Test Character", level=1, max_hp=100, current_hp=100, attack=10, defense=5, xp=0, gold=0, inventory=[], skills=[])
...
def test_update_character(character_service):
    character = Character(id=0, name="Test Character", level=1, max_hp=100, current_hp=100, attack=10, defense=5, xp=0, gold=0, inventory=[], skills=[])
    created_character = character_service.create_character(character)
    updated_character = Character(id=created_character.id, name="Updated Character", level=2, max_hp=120, current_hp=120, attack=12, defense=6, xp=0, gold=0, inventory=[], skills=[])
